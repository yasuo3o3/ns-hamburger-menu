...
### Added
- Add Responsive Position settings to new admin UI
- Integrate responsive position controls into NSHM_Admin class
- Unified option handling between admin and frontend

### Fixed
- Resolved admin menu duplication issue
- Frontend CSS variables now properly reflect admin settings
